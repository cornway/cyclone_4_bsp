...
module sdram_phy (
	...
	defparam
		...
		sdram_phy_alt_mem_phy_inst.DLL_DELAY_BUFFER_MODE = "LOW",
		sdram_phy_alt_mem_phy_inst.DLL_DELAY_CHAIN_LENGTH = 12,
		sdram_phy_alt_mem_phy_inst.DQS_DELAY_CTL_WIDTH = 6,
		sdram_phy_alt_mem_phy_inst.DQS_OUT_MODE = "DELAY_CHAIN2",
		sdram_phy_alt_mem_phy_inst.DQS_PHASE = 6000,
		sdram_phy_alt_mem_phy_inst.DQS_PHASE_SETTING = 2,
		sdram_phy_alt_mem_phy_inst.DWIDTH_RATIO = 2,
		sdram_phy_alt_mem_phy_inst.MEM_IF_DWIDTH = 16,
		sdram_phy_alt_mem_phy_inst.MEM_IF_ADDR_WIDTH = 12,
		...
		sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PAIR_COUNT = 3,
		sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PS = 10000,
		sdram_phy_alt_mem_phy_inst.MEM_IF_CLK_PS_STR = "10000 ps",
		sdram_phy_alt_mem_phy_inst.MEM_IF_MR_0 = 34,
		sdram_phy_alt_mem_phy_inst.MEM_IF_MR_1 = 0,
		sdram_phy_alt_mem_phy_inst.MEM_IF_MR_2 = 0,
		sdram_phy_alt_mem_phy_inst.MEM_IF_MR_3 = 0,
		sdram_phy_alt_mem_phy_inst.PLL_STEPS_PER_CYCLE = 80,
...
// Retrieval info:      <PRIVATE name = "mem_fmax" value="133.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_if_preset" value="hynix_HY57V641620F(L_S)TP_series"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_if_clk_pair_count" value="3"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_if_coladdr_width" value="8"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_if_tras_ns" value="63.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_if_trp_ns" value="20.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_trrd_ns" value="15.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_if_trcd_ns" value="20.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "mem_tcl" value="2.0"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "csr_en" value="true"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "t_DH" value="0.2"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "parameter" value="SIMGEN_INITIALIZATION_FILE=E:\Work\fpga\cyclone_4_bsp/sdram_phy_simgen_init.txt"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
