# -------------------------------------------------------------------------
#
# ALTMEMPHY v18.1 DDR SDRAM pin constraints script for sdram
#
...
set_instance_assignment -name IO_STANDARD "${mem_clk_IO_STANDARD}" -to ${mem_clk_pin_name}[2]
set_instance_assignment -name CURRENT_STRENGTH_NEW "${mem_clk_CURRENT_STRENGTH_NEW}" -to ${mem_clk_pin_name}[2]
...
set_instance_assignment -name IO_STANDARD "${mem_clk_n_IO_STANDARD}" -to ${mem_clk_n_pin_name}[2]
set_instance_assignment -name CURRENT_STRENGTH_NEW "${mem_clk_n_CURRENT_STRENGTH_NEW}" -to ${mem_clk_n_pin_name}[2]
...
set_instance_assignment -name CKN_CK_PAIR ON -from ${mem_clk_n_pin_name}[2] -to ${mem_clk_pin_name}[2]
